...
async function processReportResult(reportResult, mediaToDetailsMap) {
    ...
    // Filtrar apenas carrosséis com menos de 510 exibições
    ...
    if (Object.keys(structuredData).length === 0) {
        console.log(`[INFO] Nenhum carrossel ficou abaixo de 510 exibições em ${yesterdayFormatted}.`);
        return;
    }
